...
def run_dispatcher(n_worker):
    ...
    args_file2 = ["python",'yappi_main_wrapper.py', 
                  ...
                  r"demo_case4_dispatcher.main", 'dispatcher',"--management-port", "18000", "--config", 'dispatcher_case4.ini', '--n-worker', f"{n_worker}"]
...
if __name__ == "__main__":
    ...
    dispatcher_parser.read("dispatcher_case4.ini")
